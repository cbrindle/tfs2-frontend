        ...
        return (
            <div className={main}>
                ...
                <div className={newsBottom}>
                    ...
                    <p style={{ marginTop: 0 }}>Sunday funday… riiiiiight. All in all, I got a lot of work done on the site today. My for whatever reason, I was running into a major issue getting the user sign in functionality working. Everything was coming back from the server side without an issue. However, when I went to console log the results of a successful login, my variable came back as undefined. After some digging around, I found the bug. After the dispatch middleware updated my state in Redux, I never return anything to the function call. When my code went to see what came back, obviously there was nothing there.</p>

                    <p>It was like I gave you some ham, cheese, and bread and asked you to make me a sandwich, but never said to bring it to me when you were done. All the while, I’m sitting at the dinning room table, wondering where my sandwich is, you’re upstairs taking a nap because your task has been completed, and the sandwich is sitting alone in the kitchen counter! Let this be a lesson that sometimes your bug can be as simple as a lonely sandwich ;)</p>
                    <br /><br />
